                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="pull-left add_edit_delete_link">
                            @include('backend/search/union_search')
                        </div>
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr id="data_entry_id_{{$data->id}}">
                                    ...
                                    <td>{{ $data->bd_union_name }}</td>
                                    <td>
                                        <a href="{{ url($edit_url.'/'.$data->id) }}" class="btn btn-xs btn-info">Edit</a>
                                        <button type="button" class="btn btn-xs btn-info" onclick="common_delete({{$data->id}}, 'unions');">Delete</button>
                                    </td>
