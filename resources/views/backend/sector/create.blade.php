        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form class="form-horizontal" action="{{url('admin/sector/store')}}" method="post">
                             <!--to protect csrf-->
                             {{csrf_field()}} 
                            <div class="form-group">
                                ...
                                @endif
                                    <input type="text" class="form-control" id="sec1" name="sector_name" value="{{ old('sector_name') }}">
                                </div>    
                            </div>
                            <div class="form-group">
                                ...
                                @endif
                                    <input type="text" class="form-control" id="sec2" name="sector_name_bn" value="{{ old('sector_name_bn') }}">
                                </div>    
                            </div>
                            <div class="form-group">
