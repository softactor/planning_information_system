        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form class="form-horizontal" action="{{url('admin/upazila/update')}}" method="post">
                             <!--to protect csrf-->
                             {{csrf_field()}}
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <select class="form-control" id="div_id" name="div_id" onchange="loadDistrict(this.value);">
                                        ...
                                        @endphp
                                        <option value="{{$data->id}}" <?php if($division_selected_id->div_id==$data->id){ ?>selected<?php } ?>>{{$data->dvname}}</option>
                                        @php
                                        }
                                        @endphp
                                    </select>
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" id="district_id" name="district_id">
                                        ...
                                        @php
                                            ...
                                            $checkWhereParam = [
                                                    ['div_id',       '=', $division_selected_id->div_id]
                                            ];
                            ...
                            <div class="form-group">
                                ...
                                @endif
                                    <input type="text" class="form-control" id="upa1" name="upazila_name" value="{{ old('upazila_name',$edit_data->upazila_name) }}">
                                </div>    
                            </div>
                            <div class="form-group">
                                ...
                                @endif
                                    <input type="text" class="form-control" id="upa2" name="upazila_name_bn" value="{{ old('upazila_name_bn',$edit_data->upazila_name_bn) }}">
                                </div>    
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                @endif
                                    <input type="text" class="form-control" id="lati" name="upz_x" value="{{ old('upz_x',$edit_data->upz_x) }}">
                                </div>    
                            </div>
                            <div class="form-group">
                                ...
                                @endif
                                    <input type="text" class="form-control" id="long" name="upz_y" value="{{ old('upz_y',$edit_data->upz_y) }}">
                                </div>    
                            </div>
                             <div class="form-group">
