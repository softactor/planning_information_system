                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" id="district_id" name="district_id">
                                        ...
                                        @php
                                            ...
                                            $districts  =   get_table_data_by_table('districts');
                                            foreach($districts as $data){
                                        @endphp
                                        <option value="{{$data->id}}" <?php if(isset($edit_data->dis_id) && $edit_data->dis_id==$data->id){ ?>selected<?php } ?>>{{$data->district_name}}</option>
                                        @php
                                        }
                                        @endphp
                                    </select>
