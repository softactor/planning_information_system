        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form class="form-horizontal" action="{{url('admin/citycorporation/store')}}" method="post">
                             <!--to protect csrf-->
                             {{csrf_field()}}
                            ...
                            <div class="form-group">
                                ...
                                @endif
                                    <input type="text" class="form-control" id="city2" name="citycorp_name_bn" value="{{ old('citycorp_name_bn') }}">
                                </div>    
                            </div>
                            <div class="form-group">
                                ...
                                @endif
                                    <input type="text" class="form-control" id="lati" name="citycorp_x" value="{{ old('citycorp_x') }}">
                                </div>    
                            </div>
                            <div class="form-group">
                                ...
                                @endif
                                    <input type="text" class="form-control" id="long" name="citycorp_y" value="{{ old('citycorp_y') }}">
                                </div>    
                            </div>
                            <div class="form-group">
