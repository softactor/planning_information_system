        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                         <form class="form-horizontal" action="{{url('admin/agency/update')}}" method="post">
                             <!--to protect csrf-->
                             {{csrf_field()}} 
                             <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <select class="form-control" id="ministry_id" name="ministry_id" onchange="hideErrorDiv('ministry_id')">
                                        ...
                                        ?>
                                        <option value="<?php echo $data->id ?>" {{($data->id == $edit_data->min_id) ? 'selected' : ''}}><?php echo $data->ministry_name."(".$data->ministry_name_bn.")" ?></option>
                                        <?php } ?>
                                    </select>
                                </div>    
                            </div>
                            <div class="form-group">
                                ...
                                @endif
                                    <input type="text" class="form-control" id="agency1" name="agency_name" value="{{ old('agency_name',$edit_data->agency_name) }}">
                                </div>    
                            </div>
                            <div class="form-group">
                                ...
                                @endif
                                    <input type="text" class="form-control" id="agency2" name="agency_name_bn" value="{{ old('agency_name_bn',$edit_data->agency_name_bn) }}">
                                </div>    
                            </div>
                            <div class="form-group">
                                ...
                                @endif
                                    <input type="text" class="form-control" id="short" name="agency_short_name" value="{{ old('agency_short_name',$edit_data->agency_short_name) }}">
                                </div>    
                            </div>
                            <div class="form-group">
                                ...
                                @endif
                                    <?php
                                        if($edit_data->agency_code){
                                            $agency_code    =   $edit_data->agency_code;
                                        }else{
                                            $agency_code    =   "";
                                        }
                                    ?>
                                    <input type="text" class="form-control" id="code" name="agency_code" value="{{ old('agency_code',$agency_code) }}">
                                </div>    
                            </div>
                            <div class="form-group">
