<div class="search_area" id="project_quality_review">
    <form class="form-horizontal" id="project_quality_review_search_form" action="/action_page.php">
        ...
        &nbsp;
        <a href="#" style="margin-left: 25% !important" class="btn btn-default" onclick="searchFilterData('{{ url('/admin/project/project_revised_quality_review_search') }}','project_quality_review_search_form','example2')">Search</a>
    </form>    
</div>