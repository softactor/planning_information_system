                        ...
                        <form class="form-horizontal" action="{{ url('admin/project/project_agency_store') }}" method="post">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-8">
                                    ...
                                    <a href="{{ url('admin/project/project_create/'.$project_id)}}" class="btn btn-info">Back</a>
                                    <button type="button" class="btn btn-info" onclick="nextPageConfirmation('{{ url("admin/project/project_details_create") }}', 'Move to the Detailed Information screen? (Yes/NO)');">Detail Information</button>
                                </div>
                            </div>
                        </form>
                        <?php
