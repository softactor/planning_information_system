        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form class="form-horizontal" id="project_quality_review" action="{{ url('/admin/project/project_quality_review_update') }}" method="post">
                            <!--to protect csrf-->
                            {{csrf_field()}}
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    @endif
                                    <input type="text" class="form-control" id="project_entry_date" name="project_entry_date" value="{{ $project_data->project_entry_date }}" onchange="hideErrorDiv('project_entry_date')">
                                </div>    
                                <!-- </div>
                                 <div class="form-group">-->
...
<?php } ?>
        ...
        echo "selected";
    } ?>><?php echo $data->ministry_name."(".$data->ministry_name_bn.")" ?></option>
                                        <?php } ?>
                                    </select>
                                </div>    
                            </div>
        ...
        echo "selected";
    } ?>><?php echo $data->agency_name."(".$data->agency_name_bn.")" ?></option>
                                        <?php } ?>
                                    </select>
                                </div>    
                            </div>
                    ...
                    <?php } ?>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-8">
                                    ...
                                    <button type="button" class="btn btn-success" onclick="projectQualityReviewAction('project_quality_review');">Quality Review</button>
                        ...
                        <div class="pull-right project_link_information">
                            <ul>
                                ...
                                <li><a href="{{ url('/admin/project/project_agency_update')}}"><span class="fa fa-book">&nbsp;Co-agency information</span></a></li>
...
<script type="text/javascript">
    function projectQualityReviewAction(form_id){
        swal({
            title: "Quality review is completed?",
            type: "warning",
