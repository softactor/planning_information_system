...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">{{ $list_title }} Project Revision</li>
        </ol>
    </section>
                        ...
                        <form class="form-horizontal" id="project_quality_review" action="{{ url('/admin/project/project_quality_review_update') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    @endif
                                    <input type="text" class="form-control" autocomplete="off" id="project_entry_date" name="project_entry_date" value="{{ $project_data->project_entry_date }}" onchange="hideErrorDiv('project_entry_date')">
                                </div>    
                                <!-- </div>
                                 <div class="form-group">-->
                    ...
                    <?php } ?>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-8">
                                    ...
                                    <button type="button" class="btn btn-success" onclick="projectQualityReviewAction('project_quality_review');">Final Revision</button>
                        ...
                        <div class="pull-right project_link_information">
                            <ul>
                                ...
                                <li><a href="{{ url('/admin/project/project_expenditure_information_update')}}"><span class="fa fa-book">&nbsp;Expenditure Information</span></a></li>
