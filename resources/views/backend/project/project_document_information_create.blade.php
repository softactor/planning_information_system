                        ...
                        <form class="form-horizontal" action="{{ url('admin/project/project_documents_store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    ?>
                                    <select class="form-control" id="doctype" name="doctype" onchange="hideErrorDiv('doctype')">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-8">
                                    ...
                                    <a href="{{ url('admin/project/project_expenditure_information')}}" class="btn btn-info">Back</a>
                                    ...
                                    @if(isset($fas) && !empty($fas) && count($fas) > 0)
                                    <button type="button" class="btn btn-info" onclick="nextPageConfirmation('{{ url("admin/project/project_shapefile_create") }}', 'Move to Shapefile Page (Yes/ No)?');">Upload Shape File</button>
                                    @endif
                                </div>
                            </div>
                        </form>
