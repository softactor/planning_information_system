                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <?php
                            ...
                            //project version id
                            $project_version    =   get_project_version_id_by_project_id(Session::get('project_id'));
                            
                            // get latest projects progress id
                            $project_progress   =   get_project_progress_id_by_project_id($project_version->id);
                        ...
                        <form class="form-horizontal" action="{{ url('admin/project/project_expenditure_store') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="prjvtype" value="New" readonly>
                                </div>    
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    @endif
                                    <input onchange="hideErrorDiv('implstartdate')" type="text" class="form-control" id="implstartdate" autocomplete="off" name="implstartdate" value="{{ old('implstartdate',(isset($projectCost->implstartdate)? date('d-m-Y',strtotime($projectCost->implstartdate)):""))}}">
                                </div>    
                                ...
                                <div class="col-sm-3">
                                    ...
                                    @endif
                                    <input onchange="checkPeriodValidity();hideErrorDiv('implenddate')" type="text" class="form-control" id="implenddate"  autocomplete="off" name="implenddate" value="{{ old('implenddate',(isset($projectCost->implenddate)? date('d-m-Y',strtotime($projectCost->implenddate)):""))}}">
                                </div>    
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <label class="control-label col-sm-2" for="con">
                                    <div class="constituency_style">Contingency</div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-8">
                                    ...
                                    <input type="hidden" name="project_id" value="<?php echo $progress_id; ?>">
                                    <input type="submit" name="submit" value="{{ ((isset($projectCost) && !empty($projectCost))? "Update":"Save")}}" class="btn btn-success">
                                    <a href="{{ url('admin/project/project_location_create')}}" class="btn btn-info">Back</a>
                                    ...
                                    @if(isset($projectCost) && !empty($projectCost))
                                        <button type="button" class="btn btn-info" onclick="nextPageConfirmation('{{ url("admin/project/project_document_information") }}', 'Move to Document Information (Yes/ No)?');">Project Document Information</button>
                                    @endif
                                </div>
                            </div>
                        </form>
