                        ...
                        <form class="form-horizontal" action="{{ url('admin/project/project_details_store') }}" method="post">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-8">
                                    ...
                                    <a href="{{ url('admin/project/project_agency_create')}}" class="btn btn-info">Back</a>
                                    @if(isset($project_details))
                                    <button type="button" class="btn btn-info" onclick="nextPageConfirmation('{{ url("admin/project/project_foreign_assistance_create") }}', 'Move to Foreign Assistance Page (Yes/ No)?');">Foreign Assistance Information</button>
                                    <button type="button" class="btn btn-info" onclick="nextPageConfirmation('{{ url("admin/project/project_location_create") }}', 'Move to Location Page (Yes/ No)?');">Location Information</button>
                                    @endif
                                </div>
                            </div>
                        </form>
