                        ...
                        <form class="form-horizontal" action="{{ url('admin/project/project_fas_store') }}" method="post">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-8">
                                    ...
                                    <input type="submit" name="submit" id="submit_button" value="Save" class="btn btn-success">
                                    <a href="{{ url('admin/project/project_details_create')}}" class="btn btn-info">Back</a>
