            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        ?>
                        <form class="form-horizontal" action="{{ url('admin/project/revised_project_quality_store') }}" method="post">
                            {{csrf_field()}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" id="revised_date" name="revised_date" value="<?php echo date("d-m-Y"); ?>">
                                </div>    
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-8">
                                    ...
                                    <input type="hidden" name="project_version_project_id" value="<?php echo $projectCost->project_id; ?>">
                                    ...
                                    <input type="submit" name="submit" value="{{ ((isset($projectCost) && !empty($projectCost))? "Quality Review":"Quality Review")}}" class="btn btn-success">
